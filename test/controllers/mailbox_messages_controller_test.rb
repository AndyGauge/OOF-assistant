...
class MailboxMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mailbox_message" do
    assert_difference('MailboxMessage.count') do
      post mailbox_messages_url, params: { mailbox_message: { mailbox_id_id: @mailbox_message.mailbox_id_id, message_id_id: @mailbox_message.message_id_id } }
    end
  ...
  test "should update mailbox_message" do
    patch mailbox_message_url(@mailbox_message), params: { mailbox_message: { mailbox_id_id: @mailbox_message.mailbox_id_id, message_id_id: @mailbox_message.message_id_id } }
